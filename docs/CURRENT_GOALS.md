...
- الهدف التالي هو Phase 19: SF-50M Candidate Training، بشرط تكبير corpus المحكوم وعدم الاعتماد على محادثات غير مراجعة.
...
- **Phase 19:** تدريب مرشح أكبر `SF-50M` عند كفاية البيانات.
