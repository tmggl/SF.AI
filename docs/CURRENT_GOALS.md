...
ثم Phase 27.7 ثبتت split ثابتًا وcanary أقوى قبل تدريب `SF-10M v0.6`.
...
- أول فرصة لحوار قصير مولّد يقنعك: بعد تدريب `SF-10M v0.6` على train split ونجاحه على held-out eval/canary، أو نجاح `SF-50M` لاحقًا في eval v2.
