...
واكتمال corpus gate عند `5143` سجلًا. Phase 27 أثبتت أن التوجيه الحالي يمر
baseline متعدد الأدوار، وPhase 27.5 أثبتت أن التدريب بصيغة الحوار أفضل من
تسطيح الرسائل، لكنه لا يكفي بعد لحوار مولّد مقنع.
...
- أول فرصة لحوار قصير مولّد يقنعك: بعد إصلاح assistant-target/loss masking على `SF-10M` أو نجاح `SF-50M` لاحقًا في eval v2.
