...
- Phase 27 اكتمل: `make phase27-dialogue-eval` مرّر `19/19` turn في suite
  متعدد الأدوار، ووضع خطة توسعة دقيقة: `4500` سجل إضافي، `180` batch،
  بالتوازن `msa=2250` و`saudi=2250`.
...
- `chat/jsonl`: يحتوي الآن 500 سجل حوار محكوم، استُخدم لتدريب tokenizer v2.
