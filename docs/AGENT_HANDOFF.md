...
`PHASE27_110_LICENSED_INGESTION_DESIGN_DECISION`. مرّت بوابات
...
تضارب الترخيص. لا يدخل أي نص خارجي إلى corpus قبل gate لاحق صريح.
