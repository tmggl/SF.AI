...
- السبب: corpus الحالي 1550 سجلًا بعد Batch 003، والحد الأدنى العملي الحالي 5000 سجل محكوم مع توازن `msa + saudi`.
...
- المهمة الفورية الحالية: مواصلة توسعة corpus المحكومة حسب Phase 27؛ Batch 001 وBatch 002 وBatch 003 اكتملت، والمتبقي `3450` سجلًا قبل إعادة `make phase26-readiness`.
