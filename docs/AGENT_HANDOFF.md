...
- المهمة الفورية الحالية: تنفيذ توسعة corpus المحكومة حسب Phase 27، مع بقاء `make phase26-readiness` قرارًا مانعًا لأي تدريب `SF-50M` حتى تتغير المعطيات.
