...
`PHASE27_113_PERMISSIVE_LEXICAL_ALTERNATIVES_INTAKE_GATE_DECISION`. مرّت بوابات
...
وحجب Arabic WordNet 4.0 لأنه model-derived عبر Gemini.
