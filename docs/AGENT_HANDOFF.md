...
`PHASE27_116_SINALAB_SYNONYMS_QUARANTINE_SCHEMA_DECISION`. مرّت بوابات
...
git-ignored، وسجل checksum/schema دون حفظ raw rows أو كتابة corpus.
