...
`PHASE27_118_SINALAB_SYNONYMS_REFERENCE_EXTRACTION_DESIGN_DECISION`. مرّت بوابات
...
reference extraction كطبقة مرجعية فقط دون raw terms في git.
