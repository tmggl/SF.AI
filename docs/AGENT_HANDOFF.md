...
`PHASE27_114_ARABIC_ONTOLOGY_SYNONYMS_SOURCE_CARDS_DECISION`. مرّت بوابات
...
source cards وlicense matrix للمرشحين دون import أو تدريب.
