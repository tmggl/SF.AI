...
- السبب: corpus الحالي 2143 سجلًا بعد تنظيف الحوارات التشغيلية، والحد الأدنى العملي الحالي 5000 سجل محكوم مع توازن `msa + saudi`.
...
- المهمة الفورية الحالية: مواصلة توسعة corpus المحكومة حسب Phase 27؛ Batch 001 وBatch 002 وBatch 003 اكتملت، والمتبقي `2857` سجلًا قبل إعادة `make phase26-readiness`.
