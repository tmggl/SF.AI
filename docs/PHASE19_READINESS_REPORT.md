...
- corpus الحالي صغير جدًا قياسًا على SF-50M: `500` سجل تدريبي فقط.
- الحد الأدنى العملي لهذه القفزة: `5000` سجل محكوم على الأقل.
- corpus الحالي لم يعد يفتقد `msa` أو `saudi`، لكنه ما زال بعيدًا عن العدد المطلوب لـ SF-50M: `msa=250`, `saudi=250`.
