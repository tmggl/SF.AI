...
- بدأ Phase 22 Gold Dialogue Corpus v2 كبوابة جاهزية:
  ...
  - أضيفت لوحة بوابة Phase 22 داخل `/ui/chat`، تقرأ `/system/phase22-readiness` وتعرض عدد corpus الحالي، المتبقي، ونقص `msa/saudi` مباشرة.
...
- اختبارات: 4 في `test_chat_ui.py` تشمل مؤشر جودة التصدير ولوحة بوابة Phase 22.
