...
| Phase 26 | SF-25M v0.1 Dialogue Model | مخططة؛ أول فرصة لحوار مولّد قصير مقنع |
| Phase 27 | Dialogue Evaluation v2 | مخططة |
| Phase 28 | SF-50M v0.1 Candidate | مخططة؛ هدف أول حوار مولّد مقنع |
...
- يعرف أي Agent أن أول تدريب جودة مفيد هو Phase 24.
...
### الهدف
توسيع corpus من 30 سجلًا إلى 500 سجل حوار محكوم على الأقل، مع توازن فصحى/سعودي.
...
### الهدف
تدريب نموذج متوسط مخصص للحوار بعد توسيع corpus إلى نحو 2000 سجل محكوم.
...
### شروط البدء
- 5000 سجل حوار محكوم على الأقل.
- Phase 19 readiness = ready.
- tokenizer حديث.
- eval v2 جاهز.

### شروط النجاح
- أول هدف رسمي لحوار مولّد مقنع ومستقر نسبيًا.
- تفوق واضح على SF-25M في الحوار القصير.
