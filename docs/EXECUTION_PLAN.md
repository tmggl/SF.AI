...
- corpus كان `500` سجل عند قرار Phase 26، ثم صار `1050` بعد Batch 002؛ الحد العملي لـ `SF-50M` هو `5000` سجل.
...
```text
current_records      = 1050
target_records       = 5000
remaining_records    = 3950
batches_needed_total = 8
needed_by_dialect    = msa=1975, saudi=1975
```
