...
- corpus كان `500` سجل عند قرار Phase 26، ثم صار `1550` بعد Batch 003؛ الحد العملي لـ `SF-50M` هو `5000` سجل.
...
batches_needed_total = 7
needed_by_dialect    = msa=1725, saudi=1725
```
