...
- **المرحلة الحالية:** **Phase 27.119 — Synonyms Reference Extraction Dry-Run Counts** (`PHASE27_119_SINALAB_SYNONYMS_REFERENCE_DRY_RUN_COUNTS_DECISION`; counts فقط؛ لا raw terms ولا تدريب)
