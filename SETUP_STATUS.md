...
- **المرحلة الحالية:** **Phase 27.73 — Open-Social Failure Inspection** (اكتملت: فحص فشلَي `open_social`؛ سد فجوة حارس الشظايا؛ بقي semantic collapse واحد؛ runtime محجوب)
- **الهدف العام:** الوصول إلى نموذج لغوي سيادي مولّد، يبدأ من الصفر، ثم يربط توليده بالشات خلف router/safety/composer.
- **المرحلة التالية المقترحة:** Phase 27.74 targeted open_social semantic-collapse repair؛ Phase 28 و`SF-50M` محظوران حتى تنجح بوابات جودة أوسع.
