...
- **المرحلة الحالية:** **Phase 27.102 — Topic Prototype Contrastive Copy-Anchor Gate** (`PHASE27_102_TOPIC_PROTOTYPE_CONTRASTIVE_GATE_DECISION`; بوابة فقط؛ runtime محجوب)
...
- **المرحلة التالية المقترحة:** Phase 27.103 — Topic Prototype Contrastive Curriculum Pack؛ حزمة curriculum بلا تدريب جديد.
...
- الكود الحالي يعرض `Phase 27.102` في `/system/status` و`/health`; runtime المولّد العام لا يزال محجوبًا حتى نجاح gates.
