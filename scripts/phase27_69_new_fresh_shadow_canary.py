...
NEW_FRESH_CASES: tuple[ShadowCase, ...] = (
    ...
    ShadowCase("followup_12", "msa", "تابع من آخر جملة", "followup", "", "followup", ("نكمل", "بعدها", "الفكرة", "أقصد", "خطوة")),
    ...
    ShadowCase("planning_12", "msa", "أريد تنظيمًا بسيطًا للمهام", "planning", "", "planning", ("تنظيم", "مهام", "ابدأ")),
    ...
    ShadowCase("support_08", "msa", "طمئنّي بجملة قصيرة", "support", "", "support", ("تنفس", "راحة", "تستطيع", "طمأنينة")),
