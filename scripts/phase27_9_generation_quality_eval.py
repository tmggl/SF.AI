...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--checkpoints", type=Path, default=Path("artifacts/checkpoints/sf_10m_v0_7"))
    p.add_argument("--checkpoint-name", type=str, default="sf-10m-step4000")
    p.add_argument("--generator-name", type=str, default="sf_10m_v0_7")
