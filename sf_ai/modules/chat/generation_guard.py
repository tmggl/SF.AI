...
_SOCIAL_PROMPT_RULES: tuple[tuple[tuple[str, ...], tuple[str, ...], str], ...] = (
    (
        ("كيفك", "كيف حالك", "وش اخبارك", "وش أخبارك", "وش الاخبار", "وش الأخبار", "اخبارك", "أخبارك", "الاخبار", "الأخبار", "وشلونك", "شلونك", "علومك"),
        ("بخير", "تمام", "الحمد", "أنا"),
...
_TASK_PROMPT_RULES: tuple[tuple[tuple[str, ...], tuple[str, ...], str], ...] = (
    ...
    (
        ("نصيحه", "نصيحة", "نصح", "تنصح", "انصح", "دلني", "وجهني", "خطوه", "خطوة", "بدايه", "بداية"),
