...
- 348 اختبار يمر (`.venv/bin/python -m pytest tests`).
...
- اقرأ `docs/PHASE12_PREFLIGHT_REPORT.md`: إذا كان `Training permission: NOT GRANTED` فلا تبدأ التدريب حتى لو كانت الفحوصات PASS.
