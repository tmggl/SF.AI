...
- قبل أي تدريب جديد يجب وجود root-cause/decision gate حديث يسمح به صراحة.
  القرار الحالي من Phase 27.98 لا يسمح إلا بإصلاح metadata وcopy-anchor دون تدريب.
...
- المراحل من Phase 0 حتى Phase 27.98 موثقة تاريخيًا. الحالة الحالية:
  `Phase 27.98 — Topic Binding Gate Encoding and Metadata Audit`
  اكتملت كبوابة فقط وأصدرت `PHASE27_98_TOPIC_BINDING_GATE_ENCODING_DECISION`.
  ...
  صريحًا، لذلك التدريب محجوب حتى إصلاح البيانات.
  runtime و`SF-50M` وtokenizer retrain محجوبة.
- أول خطوة تالية: Phase 27.99 Topic Metadata and Copy-Anchor Data Repair.
...
2. تحقق من القسم 4 في AGENT_HANDOFF.md. مهمة "محادثة مريحة + توجيه دقيق" مكتملة، ومسار العمل الحالي هو Phase 27.99 بعد بوابة 27.98.
