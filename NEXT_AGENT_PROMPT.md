...
- تفويض التشغيل لا يعني إدخال synthetic LLM data: أي حوار يؤلفه الوكيل يبقى review-only و`training_allowed=false` حتى يمر عبر مراجعة صريحة وحوكمة datasets.
