# Phase 27.17 Prompt-to-Answer Micro-Probe Generations

## phase27_17_msa_001 — msa — FAIL

- prompt: السلام عليكم
- expected: وعليكم السلام، أهلًا بك.
- generated: وعليكأهلًا السم، أهلًا بك.
- exact_clean: False
...
- generated: القراد. ءة توسع الفهم وتزيد المفردات.
- exact_clean: False
- semantic_match: True
