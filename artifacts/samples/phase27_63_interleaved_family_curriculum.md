...
- response: نفتح حواقصيرًا عن موضوع بسيط.
- guard_reason: passed
- expected_ok: True
- family_ok: True
- reason: passed
...
- response: أقصد أن الفكرة تبدأ بخطوة واضحة.
- guard_reason: passed
- expected_ok: True
- family_ok: True
- reason: passed
...
- family: followup
- prompt: أكمل شرحك
- response: نكمل: الفكرة أن تبدأ بالسهل ثم تنتقل بعده.
- guard_reason: passed
- expected_ok: True
- family_ok: True
- reason: passed
...
- response: تقدر تهدأ، خذ نفس وذكّر نفسك أنها تعدي.
- guard_reason: passed
- expected_ok: True
- family_ok: True
- reason: passed
...
- response: الوفاء حفظ للعهد وثبات في الوثبات وثبات للعنسولف عن وثبات قليلًا في ال: تنفس بهدوء ود.
- guard_reason: passed
- expected_ok: True
- family_ok: False
- reason: response_family_mismatch
...
- response: التعاتتحمل وتكمل بدون استعجال.
- guard_reason: passed
- expected_ok: False
- family_ok: False
...
- response: الاحتاحتراسوالف عاد ية بهدوء.
- guard_reason: passed
- expected_ok: False
- family_ok: False
- reason: expected_terms_missing
