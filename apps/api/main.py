...
app = FastAPI(
    ...
    description=(
        ...
        "Phase 27.105 completed raw UI lab diagnosis; SF-10M Phase 27.81 "
        "is visible in lab mode, but official runtime remains blocked. "
...
def root() -> dict[str, str]:
    return {
        "project": "SF.AI",
        "phase": "Phase 27.105 — Raw UI Lab Result Diagnosis",
        "ui": "/ui/chat",
        "docs": "/docs",
    }
