...
app = FastAPI(
    ...
    description=(
        ...
        "Phase 27.120 completed SinaLab Synonyms local reference layer build "
        "gate with raw terms and training still blocked; "
...
def root() -> dict[str, str]:
    return {
        "project": "SF.AI",
        "phase": "Phase 27.120 — Synonyms Local Reference Layer Build Gate",
        "ui": "/ui/chat",
        "docs": "/docs",
    }
