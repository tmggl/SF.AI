...
app = FastAPI(
    ...
    description=(
        ...
        "Phase 27.15 adds social/lexical curriculum and no-repeat decoding; runtime remains blocked. "
...
def root() -> dict[str, str]:
    return {
        "project": "SF.AI",
        "phase": "Phase 27.15 — Social/Lexical Curriculum + No-Repeat Decoding",
        "ui": "/ui/chat",
        "docs": "/docs",
    }
