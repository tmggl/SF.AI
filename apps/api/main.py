...
app = FastAPI(
    ...
    description=(
        ...
        "Phase 27.90 trained bounded SF-10M with round-robin ordering and kept runtime blocked. "
...
def root() -> dict[str, str]:
    return {
        "project": "SF.AI",
        "phase": "Phase 27.90 — Bounded SF-10M Round-Robin Curriculum Repair Training",
        "ui": "/ui/chat",
        "docs": "/docs",
    }
