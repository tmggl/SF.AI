...
app = FastAPI(
    ...
    description=(
        ...
        "Phase 27.64 confirmed tokenizer v8 is required for topic lexical protection; runtime remains blocked. "
...
def root() -> dict[str, str]:
    return {
        "project": "SF.AI",
        "phase": "Phase 27.64 — Topic Lexical/Tokenizer Inspection",
        "ui": "/ui/chat",
        "docs": "/docs",
    }
