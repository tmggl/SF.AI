...
app = FastAPI(
    ...
    description=(
        ...
        "Phase 27.117 completed SinaLab Synonyms sample quality and dedupe "
        "review with import still blocked; "
...
def root() -> dict[str, str]:
    return {
        "project": "SF.AI",
        "phase": "Phase 27.117 — Synonyms Sample Quality/Dedupe Review",
        "ui": "/ui/chat",
        "docs": "/docs",
    }
