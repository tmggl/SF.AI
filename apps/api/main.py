...
app = FastAPI(
    ...
    description=(
        ...
        "Phase 27.116 completed SinaLab Synonyms quarantine checksum and "
        "schema dry-run with import still blocked; "
...
def root() -> dict[str, str]:
    return {
        "project": "SF.AI",
        "phase": "Phase 27.116 — Synonyms Quarantine Schema Dry-Run",
        "ui": "/ui/chat",
        "docs": "/docs",
    }
