...
def system_status(settings: SettingsDep) -> SystemStatusResponse:
    ...
    return SystemStatusResponse(
        ...
        env=settings.env,
        current_phase="Phase 27.8 — SF-10M v0.6 Split Training",
        current_phase_status="completed_with_numeric_improvement_runtime_blocked",
        next_phase="Repair short-generation quality on SF-10M before any SF-50M scaling",
        sovereign=True,
