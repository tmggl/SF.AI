...
def system_status(settings: SettingsDep) -> SystemStatusResponse:
    ...
    return SystemStatusResponse(
        ...
        env=settings.env,
        current_phase="Phase 27.7 — Fixed Split + Gold Social Canary",
        current_phase_status="completed_quality_gate_runtime_blocked",
        next_phase="Train SF-10M v0.6 on the fixed train split, then evaluate held-out split before SF-50M",
        sovereign=True,
