...
- **الرحلة الحالية:** Phase 27.39 / 30 — Topic-Isolation Repair اكتملت جزئيًا.
- **الأولوية الحالية:** Phase 27.40 tokenizer/context repair for topic isolation؛ لا تدريب `SF-50M` ولا Phase 28 حتى تنجح موضوعات التعريف المحجوبة.
...
- **المولّد:** runtime التجريبي يبقى على Phase 27.33 `sf-10m-step9800`; Phase 27.39 درّب probe مرشحًا لكنه فشل `10/24`، لذلك لم يُفعّل.
