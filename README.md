...
- **الأولوية الحالية:** إعادة تدريب/تحسين `SF-10M` بعد اكتمال corpus gate؛ لا تدريب `SF-50M` ولا Phase 28 حتى تمر بوابات الجودة.
