...
- **الرحلة الحالية:** Phase 27.19 / 30 — Hygiene Repair Corpus/Probe اكتملت دون تحسين كافٍ؛ runtime محظور.
- **الأولوية الحالية:** Phase 27.20 tokenizer/protected-phrase strategy؛ لا تدريب `SF-50M` ولا Phase 28 حتى تمر بوابات الجودة.
