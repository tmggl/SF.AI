...
.PHONY: phase27-sinalab-synonyms-reference-adapter-design phase27-sinalab-synonyms-reference-adapter-skeleton phase27-sinalab-synonyms-reference-adapter-local-dry-run phase27-sinalab-synonyms-reference-runtime-policy-design
...
help:
	...
	@echo "  make phase27-sinalab-synonyms-reference-adapter-design Run Phase 27.123 adapter design"
	@echo "  make phase27-sinalab-synonyms-reference-adapter-skeleton Run Phase 27.124 adapter skeleton"
	@echo "  make phase27-sinalab-synonyms-reference-adapter-local-dry-run Run Phase 27.125 adapter dry-run"
	@echo "  make phase27-sinalab-synonyms-reference-runtime-policy-design Run Phase 27.126 runtime policy design"
...
phase27-sinalab-synonyms-reference-adapter-design:
	ENABLE_SAUDI_SEED_V1_LEXICON=true $(PY) scripts/phase27_123_sinalab_synonyms_reference_adapter_design.py $(ARGS)

phase27-sinalab-synonyms-reference-adapter-skeleton:
	ENABLE_SAUDI_SEED_V1_LEXICON=true $(PY) scripts/phase27_124_sinalab_synonyms_reference_adapter_skeleton.py $(ARGS)

phase27-sinalab-synonyms-reference-adapter-local-dry-run:
	ENABLE_SAUDI_SEED_V1_LEXICON=true $(PY) scripts/phase27_125_sinalab_synonyms_reference_adapter_local_dry_run.py $(ARGS)

phase27-sinalab-synonyms-reference-runtime-policy-design:
	ENABLE_SAUDI_SEED_V1_LEXICON=true $(PY) scripts/phase27_126_sinalab_synonyms_reference_runtime_policy_design.py $(ARGS)
